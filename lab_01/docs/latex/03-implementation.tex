...
\begin{itemize}
    ...
    \item[$-$] На выход ПО должно выводить полученное расстояние и вспомогательны матрицы;
\end{itemize}
...
соответственно
\newpage
\subsection{Итеративный метод поиска Дамерау-Левенштейна}
\lstinputlisting[caption={Итеративный метод поиска Дамерау-Левенштейна}, label={lst:ld-std}, language=go, style=go,
firstline=6, lastline=36]{../../src/levenshtein/levenshtein.go}

\subsection{Рекурсивный метод поиска Дамерау-Левенштейна}
\lstinputlisting[caption={Рекурсивный метод поиска Дамерау-Левенштейна}, label={lst:ld-rec}, language=go, style=go,
...
\lstinputlisting[caption={Рекурсивный с кешированием метод поиска Дамерау-Левенштейна}, label={lst:ld-cacheRec}, language=go, style=go,
